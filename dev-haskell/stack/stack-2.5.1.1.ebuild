...
SLOT="0/${PV}"
KEYWORDS="amd64 ~x86"
IUSE="developer-mode disable-git-info hide-dependency-versions integration-tests static supported-build"
...
RDEPEND=">=dev-haskell/aeson-1.4.6.0:=[profile?]
	...
	>=dev-lang/ghc-8.6.5:=
	!disable-git-info? ( >=dev-haskell/githash-0.1.3.3:=[profile?]
				>=dev-haskell/optparse-simple-0.1.1.2:=[profile?] )
	integration-tests? ( >=dev-haskell/hspec-2.7.1:=[profile?]
				>=dev-haskell/optparse-generic-1.3.1:=[profile?] )
"
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/quickcheck-2.13.2
		...
		!integration-tests? ( >=dev-haskell/hspec-2.7.1 ) )
"
