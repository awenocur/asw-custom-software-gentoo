...
PATCHES=(
	...
	"${FILESDIR}"/${P}-fix-gpus.patch
	"${FILESDIR}"/${P}-fix-minimum-gpu.patch
	"${FILESDIR}"/${P}-fix-hip-path.patch
	"${FILESDIR}"/${P}-remove-texture-pitch-alignment-enum.patch
	"${FILESDIR}"/${P}-remove-texture-pitch-alignment-check.patch
)
